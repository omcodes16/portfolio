...
const bentoHTML = `
        ...
        <section id="repository" class="bento-repository">
            <div class="bento-header" style="text-align: center; margin-bottom: 50px;">
                <h1 style="font-family: 'Playfair Display', serif; font-size: 3.5rem; color: #fff; margin-bottom: 10px;">THE REPOSITORY <span style="font-size: 1.5rem; color: var(--text-muted); font-family: 'Inter', sans-serif;">(Om Giri’s Codex)</span></h1>
